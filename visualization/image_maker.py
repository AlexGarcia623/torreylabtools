...
#        sys.exit()
        ...
        print np.min(line_strength), np.max( line_strength )
        print age_main[  line_strength > 0  ]
        print line_strength[ line_strength > 0 ]
        print "WARNING: I've loaded the the OIII line strength into the masses"
